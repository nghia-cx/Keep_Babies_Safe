    ...
    def distancing(baby_centers, img,min,max ):  #dist_thres_lim=(100,150)
        ...
        for x in x_combs:
            ...
            if dist > min and dist < max:
                ...
                fontScale = 3
                cv2.putText(img, str(dist), org, font,
                ...
                for xy in x:
                    ...
                    if already_red[cntr] == 0:
                        ...
                        tf = 3 #max(tl - 1, 1)  # font thickness
